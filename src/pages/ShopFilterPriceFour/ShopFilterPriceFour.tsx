...
import "./ShopFilterPriceFour.css";
...
const ShopFilterPriceFour = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { Price: number; }) => product.Price >= 250000000);
...
export default ShopFilterPriceFour