...
const CaseSize29to37 = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { CaseSize: number; }) => product.CaseSize >= 29 && product.CaseSize <= 37);
