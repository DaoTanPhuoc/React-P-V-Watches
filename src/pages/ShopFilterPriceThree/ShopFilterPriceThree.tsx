...
const ShopFilterPriceThree = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { Price: number; }) => product.Price >= 200000000 && product.Price <= 250000000);
...
export default ShopFilterPriceThree