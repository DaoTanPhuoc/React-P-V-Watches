...
const ShopFilterPriceOne = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { Price: number; }) => product.Price >= 100000000 && product.Price <= 150000000);
...
export default ShopFilterPriceOne