...
const CaseSizeOver42 = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { CaseSize: number; }) => product.CaseSize >= 42);
