...
const ShopFilterPriceTwo = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { Price: number; }) => product.Price >= 150000000 && product.Price <= 200000000);
...
export default ShopFilterPriceTwo
