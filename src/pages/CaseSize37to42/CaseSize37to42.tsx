...
const CaseSize37to42 = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { CaseSize: number; }) => product.CaseSize >= 37 && product.CaseSize <= 42);
                ...
                <div className="container-ban">
                    <div className="ban_img">
                        <img
                            ...
                            src="https://www.etiqus.co.uk/wp/wp-content/uploads/2015/02/Etiqus-Sport-Pro-Banner.jpg"
                            alt="banner"
                        />
