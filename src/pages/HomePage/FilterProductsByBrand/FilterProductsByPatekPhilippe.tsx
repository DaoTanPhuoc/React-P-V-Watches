...
const FilterProductsByPatekPhilippe = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { BrandName: string; }) => product.BrandName === "Patek Philippe");
                ...
                <div className="container-ban">
                    <div className="ban_img">
                        <img
                            ...
                            src="https://mastersexpo.com/wp-content/uploads/2022/08/Newsletter-banner-preowned-3000-x-914-px-1.png"
                            alt="banner"
                        />
...
export default FilterProductsByPatekPhilippe