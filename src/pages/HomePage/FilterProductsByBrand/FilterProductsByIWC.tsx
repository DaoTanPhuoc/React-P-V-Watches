...
const FilterProductsByIWC = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { BrandName: string; }) => product.BrandName === "IWC");
                ...
                <div className="container-ban">
                    <div className="ban_img">
                        <img
                            ...
                            src="https://www.hautehorologe.ae/image/catalog/brands/iwc/banner.png"
                            alt="banner"
                        />
...
export default FilterProductsByIWC