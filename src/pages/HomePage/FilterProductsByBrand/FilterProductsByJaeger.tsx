...
const FilterProductsByJaeger = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { BrandName: string; }) => product.BrandName === "Jaeger");
                ...
                <div className="container-ban">
                    <div className="ban_img">
                        <img
                            ...
                            src="https://img.jaeger-lecoultre.com/video-poster-1/c037ee43321972d1c1a95b0a2e0833a9d2204cda.jpg"
                            alt="banner"
                        />
...
export default FilterProductsByJaeger