...
const FilterProductsByBreiting = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((result) => {
                const filteredProducts = result.data.filter((product: { BrandName: string; }) => product.BrandName === "Breiting");
...
export default FilterProductsByBreiting